...
SET SOURCE=..\source\platform_win32\compiler_translation_unit.cpp ..\libs\imgui\imgui.cpp ..\libs\imgui\imgui_demo.cpp ..\libs\imgui\imgui_draw.cpp ..\libs\imgui\imgui_impl_dx11.cpp ..\libs\imgui\imgui_impl_win32.cpp ..\libs\imgui\imgui_widgets.cpp
